...
7. **Ideas**
Got coding ideas and principles from the following resources:
   - https://www.digitalocean.com/community/tutorials/how-to-use-many-to-many-database-relationships-with-flask-sqlalchemy
   - https://github.com/ZeyadTareq224/Fyyur-Flask/blob/master/app.py (Coding principles and idea of project) on the 08/10/2022
   - Stackoverflow for debug